...
const PROGRAMS = [
  {
    ...
    body: 'Monthly mobile clinics staffed by trained volunteer nurses, plus a network of community health workers who follow up between visits. In 2025, outreach days reached 42 chiefdoms.',
    seed: 'sh-prog-health',
  },
  {
  ...
  return (
    <>
      <PageHero
        ...
        image="https://picsum.photos/seed/sh-programs-hero/700/560"
          ...
          <div className="program-list">
            {PROGRAMS.map((p, i) => (
              <article className="program-row" key={p.title}>
                <img src={`https://picsum.photos/seed/${p.seed}/440/320`} alt={`${p.title} program in Sierra Leone`} />
                <div>
